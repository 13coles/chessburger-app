...
$sql = "
        ...
        GROUP BY order_number, user_info, method, placed_on, order_status, table_id, order_type, time, date, proof_payment;
        ";
...
if ($result) {
    ...
    echo '<div class="empty-box">
             <p class="empty-message">No records found for the selected order type!</p>
        </div>
        ';
}
?>
